...
export default function Simulation() {
  ...
  const updateParameterValues = () => {
    ...
    if (param1) setParam1Value(param1.currentValue);
    if (param2) setParam2Value(param2.currentValue);
  };
  ...
  const getScenarioColor = (scenario: SimulationScenario) => {
    if (scenario.name === 'Best Case') return 'border-green-200 bg-green-50';
    if (scenario.name === 'Worst Case') return 'border-red-200 bg-red-50';
    if (scenario.name === 'Base Case') return 'border-blue-200 bg-blue-50';
