          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardTitle className="text-blue-700">
                {accounts.find(a => a.id === selectedAccountForTransaction)?.name} - Yeni İşlem
              </CardTitle>
              <Button
                variant="ghost"
                size="sm"
            ...
            <CardDescription>
              {accounts.find(a => a.id === selectedAccountForTransaction)?.bankName} hesabına işlem ekleyin
            </CardDescription>
          </CardHeader>
          <CardContent>
            <AccountTransactionForm
              account={accounts.find(a => a.id === selectedAccountForTransaction)!}
              onAddTransaction={handleAddTransaction}
