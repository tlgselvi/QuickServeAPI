...
export default function BankAccountCard({ bank, onAddTransaction, onViewHistory }: BankAccountCardProps) {
  ...
  const getMinimumPayment = (productType: string) => {
    switch (productType) {
      case 'creditCard':
        return bank.creditCardMinimumPayment ? `${bank.creditCardMinimumPayment} TL` : null;
      case 'loan':
        return bank.loanMinimumPayment ? `${bank.loanMinimumPayment} TL` : null;
      default:
        return null;
    }
  };
                ...
                <div className="mt-3 pt-3 border-t">
                  <AccountTransactionForm
                    ...
                    subAccount={{
                      ...
                      // Add sub-account specific data based on product type
